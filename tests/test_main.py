...
class TestYOPMCPFunctions:
    ...
    def test_yeepay_yop_overview(self, mock_download):
        ...
        mock_download.assert_called_once_with("https://open.yeepay.com/docs-v3/llms.txt")
    ...
    def test_yeepay_yop_product_overview(self, mock_download):
        ...
        mock_download.assert_called_once_with("https://open.yeepay.com/docs-v3/product/llms.txt")
    ...
    def test_yeepay_yop_product_detail_success(self, mock_download):
        ...
        mock_download.assert_called_once_with("https://open.yeepay.com/docs-v3/product/user-scan/llms.txt")
    ...
    def test_yeepay_yop_sdk_and_tools_guide(self, mock_download):
        ...
        mock_download.assert_called_once_with("https://open.yeepay.com/docs-v3/platform/llms.txt")
    ...
    def test_yeepay_yop_link_detail_http_url(self, mock_download):
        ...
        result = yeepay_yop_link_detail("https://open.yeepay.com/docs-v3/platform/201.md")
        
        assert result == "# Link Detail\nTest link content"
        mock_download.assert_called_once_with("https://open.yeepay.com/docs-v3/platform/201.md")
    ...
    @patch('tools.cert_utils.gen_key_pair')
    def test_yeepay_yop_gen_key_pair(self, mock_gen_key_pair):
        ...
        mock_gen_key_pair.assert_called_once_with(algorithm="RSA", format="pkcs8", storage_type="file")

    @patch('tools.cert_utils.download_cert')
    ...
    @patch('tools.cert_key_parser.parse_certificates')
