        ...
        if req_params:
            ...
            for content_type, params in req_params.items():
                ...
                if params:
                    ...
                    # 添加参数行
                    def add_param_row(param, indent_level=0):
                        ...
                        if indent_level > 0 or not is_json_content_type:
                        ...
                        if param_type == 'object' and 'ref' in param:
                            ...
                            for child in modelJson:
                                add_param_row(child, indent_level + 1)
...
def main():
    ...
    try:
        converter = ApiMdConverter(args.json_file, args.output_dir)
